...
const CHARACTER_LOADOUTS = [
  ...
  { name: "딸기 요리사", color: 0xff567f, accent: 0xfff2d2, movement: "jump", disruption: "oil" },
  ...
  { name: "화이트 의무원", color: 0xe8edf5, accent: 0x51d6c5, movement: "jump", disruption: "power-push" },
  { name: "네이비 잠입꾼", color: 0x263b78, accent: 0x8a96ff, movement: "sprint", disruption: "fluidize" },
  ...
  { name: "실버 꼬마비행사", color: 0x9aa9bd, accent: 0xff684d, movement: "jump", disruption: "swap" },
];
const SKILL_LABELS = {
  sprint: "달리기",
  jump: "점프",
