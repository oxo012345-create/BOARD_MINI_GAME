...
const CHARACTER_LOADOUTS = [
  ...
  { name: "딸기 요리사", color: 0xff567f, accent: 0xfff2d2, movement: "jump", disruption: "fluidize" },
  { name: "레몬 탐험가", color: 0xffd33f, accent: 0x4e9cff, movement: "sprint", disruption: "swap" },
  { name: "블루 연구원", color: 0x4d91ff, accent: 0x79f4ff, movement: "jump", disruption: "freeze" },
  { name: "보라 수호자", color: 0x9a62f2, accent: 0xffd84c, movement: "sprint", disruption: "oil" },
  { name: "주황 정비사", color: 0xff842d, accent: 0x3a4962, movement: "jump", disruption: "power-push" },
  { name: "라임 냉동원", color: 0x83e34f, accent: 0x42d8ff, movement: "sprint", disruption: "fluidize" },
  { name: "차콜 조련사", color: 0x586174, accent: 0xff4f72, movement: "jump", disruption: "oil" },
  { name: "레드 구조대", color: 0xe9434f, accent: 0xffd349, movement: "sprint", disruption: "freeze" },
  { name: "아쿠아 잠수부", color: 0x28c4ce, accent: 0x7ff5ff, movement: "jump", disruption: "swap" },
  { name: "골드 보물꾼", color: 0xe2ad31, accent: 0xffef7a, movement: "sprint", disruption: "power-push" },
  { name: "화이트 의무원", color: 0xe8edf5, accent: 0x51d6c5, movement: "jump", disruption: "fluidize" },
  { name: "네이비 잠입꾼", color: 0x263b78, accent: 0x8a96ff, movement: "sprint", disruption: "oil" },
  { name: "브라운 창고지기", color: 0x9b643c, accent: 0xf1ba6b, movement: "jump", disruption: "freeze" },
  { name: "마젠타 연금술사", color: 0xd94eb7, accent: 0x73f29e, movement: "sprint", disruption: "swap" },
  { name: "실버 꼬마비행사", color: 0x9aa9bd, accent: 0xff684d, movement: "jump", disruption: "fluidize" },
];
const SKILL_LABELS = {
  sprint: "달리기",
  jump: "점프",
