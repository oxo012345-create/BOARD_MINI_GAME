...
const SFX_TRACKS = {
  "item-pickup": "./sfx-item-pickup.wav",
  "item-drop": "./sfx-item-drop.wav",
  push: "./sfx-push.wav",
  "power-push": "./sfx-power-push.wav",
  sprint: "./sfx-sprint.wav",
  jump: "./sfx-jump.wav",
  freeze: "./sfx-freeze.wav",
  swap: "./sfx-swap.wav",
  oil: "./sfx-oil.wav",
  fluidize: "./sfx-fluidize.wav",
  immunity: "./sfx-immunity.wav",
};
const SKILL_SFX = {
  push: "push",
...
function connectMultiplayer() {
  ...
  socket.addEventListener("error", () => {
    setOnlineStatus("connecting", `${activeRoomCode || requestedRoomCode} · 서버 확인`, 1);
  });
}
...
function updateMultiplayer(delta) {
  ...
  if (networkSendAccumulator < 1 / 15) return;
...
const lavaNoiseTexture = surfaceTextureLoader.load("./lava-cloud.png");
const lavaTileTexture = surfaceTextureLoader.load("./lava-tile.jpg");
...
const snowDiffuseTexture = surfaceTextureLoader.load("./snow-diffuse.jpg");
const snowNormalTexture = surfaceTextureLoader.load("./snow-normal.jpg");
const snowRoughnessTexture = surfaceTextureLoader.load("./snow-rough.jpg");
const snowDisplacementTexture = surfaceTextureLoader.load("./snow-displacement.jpg");
...
const snowFieldDiffuseTexture = surfaceTextureLoader.load("./snow-diffuse.jpg");
const snowFieldNormalTexture = surfaceTextureLoader.load("./snow-normal.jpg");
const snowFieldRoughnessTexture = surfaceTextureLoader.load("./snow-rough.jpg");
const snowFieldDisplacementTexture = surfaceTextureLoader.load("./snow-displacement.jpg");
[
